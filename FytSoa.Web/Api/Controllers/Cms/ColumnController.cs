...
namespace FytSoa.Api.Controllers.Cms
{
    ...
    public class ColumnController : BaseController
    {
        ...
        public ColumnController(ICmsColumnService columnService, ICmsTemplateService tempService, IDistributedCache cache) : base(cache)
        {
        ...
        {
            return Ok(await _columnService.TreeAsync(param.types, SiteGuid));
        }
